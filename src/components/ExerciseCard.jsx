      ...
      <div className='flex w-full'>
        <div className='w-1/2 p-4'>
          {['reps', 'rest', 'tempo'].map((info) => (
            <div key={info} className='flex flex-col p-2 rounded border-[1.5px] border-solid border-slate-900 w-full mb-2'>
              <div>
        ...
        <div className='w-1/2 p-4 flex items-center justify-center'>
          <div className='w-full h-full p-2 rounded border-[1.5px] border-solid border-slate-200'>
            <ReactPlayer
