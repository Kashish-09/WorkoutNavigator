...
export default function Hero() {
  return (
    <div className='min-h-screen flex flex-col gap-10 items-center justify-center max-w-[800px] w-full mx-auto p-4'>
        ...
        <span className='text-white font-bold'> unbelievably swolenormous </span> 
        and accept all risks of becoming the local 
        <span className='text-white font-bold'> mass montrosity</span>
        , afflicted with severe body dismorphis, unable to fit through doors.
        </p>
        <Button func={() =>{
